...
def nztm_to_lat_long(input_filename, output_filename):
    ...
    """
    with open(input_filename, newline='') as csvfile, open(output_filename, 'w') as outfile:
        outfile.write("site_id, latitude, longitude\n")

        fieldnames = ['site_id', 'x', 'y']
        ...
        for line in reader:
            ...
            northing = float(nztm_n)
            easting = float(nztm_e)
...
if __name__ == "__main__":
    ...
    nztm_to_lat_long(args.input, args.output)
